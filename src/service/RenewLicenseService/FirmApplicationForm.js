...
const addNewFirmApplication = (obj)=>{
	return API.post(RENEW_LICENSE_SERVICE+ADD_NEW_FIRM_APPLICATION_FORM, obj);
}


const updateFirmApplication = (obj)=>{
	return API.post(RENEW_LICENSE_SERVICE+UPDATE_FIRM_APPLICATION_FORM, obj);
}

const getAllFirmApplication = (userName) =>{
    return API.get(RENEW_LICENSE_SERVICE+GET_FIRM_APPLICATION_BY_USERNAME,{
        params:{
            userName:userName
        }
        })
...
const addNewFirmApplication4 = (obj)=>{
	return API.post(RENEW_LICENSE_SERVICE+ADD_NEW_FIRM_APPLICATION_FORM4, obj);
}


const updateFirmApplication4 = (obj)=>{
	return API.post(RENEW_LICENSE_SERVICE+UPDATE_FIRM_APPLICATION_FORM4, obj);
}

const getAllFirmApplication4 = (userName) =>{
    return API.get(RENEW_LICENSE_SERVICE+GET_FIRM_APPLICATION_BY_USERNAME4,{
        params:{
            userName:userName
        }
        })
...
const addNewFirmApplication2 = (obj)=>{
	return API.post(RENEW_LICENSE_SERVICE+ADD_NEW_FIRM_APPLICATION_FORM2, obj);
}


const updateFirmApplication2 = (obj)=>{
	return API.post(RENEW_LICENSE_SERVICE+UPDATE_FIRM_APPLICATION_FORM2, obj);
}

const getAllFirmApplication2 = (userName) =>{
    return API.get(RENEW_LICENSE_SERVICE+GET_FIRM_APPLICATION_BY_USERNAME2,{
        params:{
            userName:userName
        }
        })
...
const addNewFirmApplication3 = (obj)=>{
	return API.post(RENEW_LICENSE_SERVICE+ADD_NEW_FIRM_APPLICATION_FORM3, obj);
}


const updateFirmApplication3 = (obj)=>{
	return API.post(RENEW_LICENSE_SERVICE+UPDATE_FIRM_APPLICATION_FORM3, obj);
}

const getAllFirmApplication3 = (userName) =>{
    return API.get(RENEW_LICENSE_SERVICE+GET_FIRM_APPLICATION_BY_USERNAME3,{
        params:{
            userName:userName
        }
        })
