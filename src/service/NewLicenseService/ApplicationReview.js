...
import {encrypt} from "../../components/global/util/EncryptDecrypt" ;
	...
	const GET_APPLICATIONFORM6_BY_USERNAME="/get-all-application-data";
	...
	const GET_ALL_APPLICATION_REVIEW_BY_USERNAME="/get-all-application-review-by-username";
	const GET_ALL_APPLICATION_DATA_BY_USERNAMES="/get-all-application-datas";
	...
	const addFirmApplicationReview = (obj)=>{
		return API.post(NERLICENSE_SERVICE+FIRM_APPLICATION_REVIEW, obj);
	}
	const addGovernmentAgencyApplicationReveiw = (obj)=>{
		return API.post(NERLICENSE_SERVICE+GOVERNMENT_AGENCY_APPLICATION_REVIEW, obj);
	}

	const addNewIndividualReview = (obj)=>{
		return API.post(NERLICENSE_SERVICE+ADD_NEW_INDIVIDUAL_FORM, obj);
	}
	...
	const getAllApplicationReviewList = () =>{
		return API.get(NERLICENSE_SERVICE+GET_ALL_APPLICATION_REVIEW);
	}
	...
	const getAllApplicationReviewByUserName = (userName) =>{
		...
		return API.get(NERLICENSE_SERVICE+GET_ALL_APPLICATION_REVIEW_BY_USERNAME,{
			params:{
				userName:userName
			}
		})
	...
	const getAllApplicationReviewByUserNames = (userName) =>{

		return API.get(NERLICENSE_SERVICE+GET_ALL_APPLICATION_DATA_BY_USERNAMES,{
			params:{
				userName:userName
			}
		})
...
export default{
    addFirmApplicationReview,
				...
				getAllApplicationReviewByUserNames
            };
