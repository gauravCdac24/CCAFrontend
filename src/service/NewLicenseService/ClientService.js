...
Get all new application where status = Recommended for In Principle Approval
...
Get all new application where status = Document Submitted for License
...
Get all new application where status = Bank Guarantee Proof Uploaded
...
Get all new application where status = License Issued
