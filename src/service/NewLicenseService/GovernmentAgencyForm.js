...
//Country APIs
    ...
    const APPLICATION_FORM_GENERATE_FOR_ORGANIZATION = "/generate-organization-application-form-pdf";
...
const addNewGovernmentAgency = (obj)=>{
	return API.post(ADMIN_SERVICE+ADD_NEW_GOVERNMENT_AGENCY_FORM, obj);
}
...
const generatePdf = (intentId) =>{
	return API.get(ADMIN_SERVICE+APPLICATION_FORM_GENERATE_FOR_ORGANIZATION,{
		params:{
			intentId:intentId
		},
		responseType: 'blob', 
