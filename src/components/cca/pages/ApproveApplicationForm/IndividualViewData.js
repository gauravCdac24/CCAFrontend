...
const ViewCessationApplication = (props) => {
  // const navigate = useNavigate();
  const { id } = useParams();
  //  const userName = decrypt(id);
  const userName = props.userName || (id ? decrypt(id) : null);
  console.log(userName);
  const routeRootPath = useSelector(
    (state) => state.jwtAuthentication.rolePath
  );

  const reviewerUserName = useSelector(
    (state) => state.jwtAuthentication.username
  );
    ...
    if (userName) {
      ...
      ApplicationForm.getApplicationForm6ByUsername(userName)
        .then((response) => {
          ...
          const cpsDoc = documents.find(
            (doc) => doc.documentTitle === "CPSDocument"
          );
  ...
  if (
    ...
    Object.keys(basicDetailsFormValues).length === 0
  ) {
    ...
    ApplicationForm.addAllRejectedAData(checkedRows)
      .then((response) => {
        ...
        showAlert({
          ...
          confirmText: "Ok",
          // onConfirm: () =>
          //   (window.location.href = "/cca/rejectedreviewapplication"),
          onConfirm: () => {
    ...
    ApplicationForm.addAllAproved(formData)
      .then((response) => {
        showAlert({
          ...
          confirmText: "Ok",
          // onConfirm: () =>
          //   (window.location.href = "/cca/approvedreviewapplication"),
          onConfirm: () => {
            if (props.onSuccess) props.onSuccess();
          },
        });
              ...
              >
                <Box sx={{ width: "100%" }}>
                  <Typography variant="h4">
                    Form for Application for Grant of Licence to be a Certifying
                    Authority
                  </Typography>
                  <Box>
                    ...
                    <Grid item sm={6} container alignItems="center">
                      ...
                      <Grid item sm={7}>
                        <Checkbox
                          ...
                          inputProps={{
                            "aria-label": "Last Name/Surname Checkbox",
                          }}
                          disabled
                        />
                      </Grid>
                    ...
                    <Grid item sm={6} container alignItems="center">
                      ...
                      <Grid item sm={7}>
                        <Checkbox
                          ...
                          onChange={(e) =>
                            handleCheckboxChange(e, "firstName1")
                          }
                    ...
                    <Grid item sm={6} container alignItems="center">
                      ...
                      <Grid item sm={7}>
                        <Checkbox
                          ...
                          onChange={(e) =>
                            handleCheckboxChange(e, "middleName1")
                          }
                    ...
                    <Grid item sm={6} container alignItems="center">
                      ...
                      <Grid item sm={7}>
                        <Checkbox
                          ...
                          inputProps={{
                            "aria-label":
                              "Last Name/Surname Checkbox (Other Name)",
                          }}
                          disabled
                        />
                      </Grid>
                    ...
                    <Grid item sm={6} container alignItems="center">
                      ...
                      <Grid item sm={7}>
                        <Checkbox
                          ...
                          onChange={(e) =>
                            handleCheckboxChange(e, "firstName2")
                          }
                          inputProps={{
                            "aria-label": "First Name Checkbox (Other Name)",
                          }}
                          disabled
                        />
                      </Grid>
                    ...
                    <Grid item sm={6} container alignItems="center">
                      ...
                      <Grid item sm={7}>
                        <Checkbox
                          ...
                          onChange={(e) =>
                            handleCheckboxChange(e, "middleName2")
                          }
                          inputProps={{
                            "aria-label": "Middle Name Checkbox (Other Name)",
                          }}
                          disabled
                        />
                      </Grid>
                    ...
                    <Grid item sm={6} container alignItems="center">
                      ...
                      <Grid item sm={7}>
                        <Checkbox
                          ...
                          onChange={(e) =>
                            handleCheckboxChange(e, "residentialBlockNo")
                          }
                          inputProps={{
                            "aria-label": "Residential Block No Checkbox",
                          }}
                          disabled
                        />
                      </Grid>
                    ...
                    <Grid item sm={6} container alignItems="center">
                      ...
                      <Grid item sm={7}>
                        <Checkbox
                          ...
                          onChange={(e) =>
                            handleCheckboxChange(e, "residentialVillage")
                          }
                          inputProps={{
                            "aria-label": "Residential Village Checkbox",
                          }}
                          disabled
                        />
                      </Grid>
                    ...
                    <Grid item sm={6} container alignItems="center">
                      ...
                      <Grid item sm={7}>
                        <Checkbox
                          ...
                          onChange={(e) =>
                            handleCheckboxChange(e, "residentialPostOffice")
                          }
                          inputProps={{
                            "aria-label": "Residential Post Office Checkbox",
                          }}
                          disabled
                        />
                      </Grid>
                    ...
                    <Grid item sm={6} container alignItems="center">
                      ...
                      <Grid item sm={7}>
                        <Checkbox
                          ...
                          onChange={(e) =>
                            handleCheckboxChange(e, "residentialSubDivision")
                          }
                          inputProps={{
                            "aria-label": "Residential Subdivision Checkbox",
                          }}
                          disabled
                        />
                      </Grid>
                  ...
                  <Grid container spacing={2} sx={{ ml: 1 }}>
                    ...
                    <Grid item sm={6} container alignItems="center">
                      <Grid item sm={5}>
                        <Typography variant="body1">{`${getCityNameById(
                          basicDetailsFormValues2.residentialAddress.city
                        )}`}</Typography>
                      </Grid>
                      <Grid item sm={7}>
                        <Checkbox
                          ...
                          onChange={(e) =>
                            handleCheckboxChange(e, "residentialCity")
                          }
                          inputProps={{
                            "aria-label": "Residential City Checkbox",
                          }}
                          disabled
                        />
                      </Grid>
                  ...
                  <Grid container spacing={2} sx={{ ml: 1 }}>
                    ...
                    <Grid item sm={6} container alignItems="center">
                      <Grid item sm={5}>
                        <Typography variant="body1">{`${getStateNameById(
                          basicDetailsFormValues2.residentialAddress.state
                        )}`}</Typography>
                      </Grid>
                      <Grid item sm={7}>
                        <Checkbox
                          ...
                          onChange={(e) =>
                            handleCheckboxChange(e, "residentialState")
                          }
                          inputProps={{
                            "aria-label": "Residential State Checkbox",
                          }}
                          disabled
                        />
                      </Grid>
                    ...
                    <Grid item sm={6} container alignItems="center">
                      ...
                      <Grid item sm={7}>
                        <Checkbox
                          ...
                          onChange={(e) =>
                            handleCheckboxChange(e, "residentialPin")
                          }
                          inputProps={{
                            "aria-label": "Residential Pin Checkbox",
                          }}
                          disabled
                        />
                      </Grid>
                    ...
                    <Grid item sm={6} container alignItems="center">
                      ...
                      <Grid item sm={7}>
                        <Checkbox
                          ...
                          onChange={(e) =>
                            handleCheckboxChange(e, "residentialTelephoneNo")
                          }
                          inputProps={{
                            "aria-label": "Residential Telephone No Checkbox",
                          }}
                          disabled
                        />
                      </Grid>
                    ...
                    <Grid item sm={6} container alignItems="center">
                      ...
                      <Grid item sm={7}>
                        <Checkbox
                          ...
                          onChange={(e) =>
                            handleCheckboxChange(e, "residentialFax")
                          }
                          inputProps={{
                            "aria-label": "Residential Fax Checkbox",
                          }}
                          disabled
                        />
                      </Grid>
                    ...
                    <Grid item sm={6} container alignItems="center">
                      ...
                      <Grid item sm={7}>
                        <Checkbox
                          ...
                          onChange={(e) =>
                            handleCheckboxChange(e, "residentialMobile")
                          }
                          inputProps={{
                            "aria-label": "Residential Mobile Checkbox",
                          }}
                          disabled
                        />
                      </Grid>
                    ...
                    <Grid item sm={6} container alignItems="center">
                      ...
                      <Grid item sm={7}>
                        <Checkbox
                          ...
                          onChange={(e) =>
                            handleCheckboxChange(e, "officeBlockNo")
                          }
                          inputProps={{
                            "aria-label": "Office Block No Checkbox",
                          }}
                          disabled
                        />
                      </Grid>
                    ...
                    <Grid item sm={6} container alignItems="center">
                      ...
                      <Grid item sm={7}>
                        <Checkbox
                          ...
                          onChange={(e) =>
                            handleCheckboxChange(e, "officeVillage")
                          }
                          inputProps={{
                            "aria-label": "Office Village Checkbox",
                          }}
                          disabled
                        />
                      </Grid>
                    ...
                    <Grid item sm={6} container alignItems="center">
                      ...
                      <Grid item sm={7}>
                        <Checkbox
                          ...
                          onChange={(e) =>
                            handleCheckboxChange(e, "officePostOffice")
                          }
                          inputProps={{
                            "aria-label": "Office Post Office Checkbox",
                          }}
                          disabled
                        />
                      </Grid>
                    ...
                    <Grid item sm={6} container alignItems="center">
                      ...
                      <Grid item sm={7}>
                        <Checkbox
                          ...
                          onChange={(e) =>
                            handleCheckboxChange(e, "officeSubDivision")
                          }
                          inputProps={{
                            "aria-label": "Office Subdivision Checkbox",
                          }}
                          disabled
                        />
                      </Grid>
                  ...
                  <Grid container spacing={2} sx={{ ml: 1 }}>
                    ...
                    <Grid item sm={6} container alignItems="center">
                      <Grid item sm={5}>
                        <Typography variant="body1">{`${getCityNameById(
                          basicDetailsFormValues2.officialAddress.city
                        )}`}</Typography>
                      </Grid>
                      <Grid item sm={7}>
                        <Checkbox
                          ...
                          onChange={(e) =>
                            handleCheckboxChange(e, "officeCity")
                          }
                  ...
                  <Grid container spacing={2} sx={{ ml: 1 }}>
                    ...
                    <Grid item sm={6} container alignItems="center">
                      <Grid item sm={5}>
                        <Typography variant="body1">{`${getStateNameById(
                          basicDetailsFormValues2.officialAddress.state
                        )}`}</Typography>
                      </Grid>
                      <Grid item sm={7}>
                        <Checkbox
                          ...
                          onChange={(e) =>
                            handleCheckboxChange(e, "officeState")
                          }
                    ...
                    <Grid item sm={6} container alignItems="center">
                      ...
                      <Grid item sm={7}>
                        <Checkbox
                          ...
                          onChange={(e) =>
                            handleCheckboxChange(e, "officeTelephoneNo")
                          }
                          inputProps={{
                            "aria-label": "Office Telephone No Checkbox",
                          }}
                          disabled
                        />
                      </Grid>
                  ...
                  <Grid container spacing={2} sx={{ ml: 1 }}>
                    ...
                    <Grid item sm={6} container alignItems="center">
                      <Grid item sm={5}>
                        <Typography variant="body1">{`${
                          basicDetailsFormValues2.officialAddress.fax || "N/A"
                        }`}</Typography>
                      </Grid>
                      <Grid item sm={7}>
                        <Checkbox
  ...
  <Grid item sm={6} container alignItems="center">
    ...
    <Grid item sm={7}>
      ...
      />
                      ...
                      >
                        <FormControlLabel
                          ...
                          control={
                            <Radio
                              checked={
                                basicDetailsFormValues2.communicationAddress ===
                                "Residential"
                              }
                            />
                          }
                    ...
                    <Grid item sm={6} container alignItems="center">
                      ...
                      <Grid item sm={7}>
                        <Checkbox
                          ...
                          onChange={(e) =>
                            handleCheckboxChange(e, "fatherLastName")
                          }
                          inputProps={{
                            "aria-label": "Father Last Name Checkbox",
                          }}
                          disabled
                        />
                      </Grid>
                    ...
                    <Grid item sm={6} container alignItems="center">
                      ...
                      <Grid item sm={7}>
                        <Checkbox
                          ...
                          onChange={(e) =>
                            handleCheckboxChange(e, "fatherFirstName")
                          }
                          inputProps={{
                            "aria-label": "Father First Name Checkbox",
                          }}
                          disabled
                        />
                      </Grid>
                    ...
                    <Grid item sm={6} container alignItems="center">
                      ...
                      <Grid item sm={7}>
                        <Checkbox
                          ...
                          onChange={(e) =>
                            handleCheckboxChange(e, "fatherMiddleName")
                          }
                          inputProps={{
                            "aria-label": "Father Middle Name Checkbox",
                          }}
                          disabled
                        />
                      </Grid>
                      ...
                      >
                        <FormControlLabel
                          ...
                          control={
                            <Radio
                              checked={
                                basicDetailsFormValues.application.gender ===
                                "Male"
                              }
                            />
                          }
                  ...
                  <Grid container alignItems="center">
                    ...
                    <Grid item sm={6} container alignItems="center">
                      ...
                      <Grid item sm={7}>
                        <Checkbox
                          checked={
                            checkIsFieldChecked("dob", element.reviewId) ||
                            false
                          }
                          onChange={(e) => handleCheckboxChange(e, "dob")}
                          inputProps={{
                            "aria-label": "Date of Birth Checkbox",
                          }}
                          disabled
                        />
                      </Grid>
                    ...
                    <Grid item sm={6} container alignItems="center">
                      ...
                      <Grid item sm={7}>
                        <Checkbox
                          ...
                          onChange={(e) =>
                            handleCheckboxChange(e, "nationality")
                          }
                  ...
                  <Typography variant="h6">9. Credit Card Details:</Typography>
                    ...
                    <Grid item sm={6} container alignItems="center">
                      ...
                      <Grid item sm={7}>
                        <Checkbox
                          ...
                          onChange={(e) =>
                            handleCheckboxChange(e, "creditCardType")
                          }
                          inputProps={{
                            "aria-label": "Credit Card Type Checkbox",
                          }}
                          disabled
                        />
                      </Grid>
                    ...
                    <Grid item sm={6} container alignItems="center">
                      ...
                      <Grid item sm={7}>
                        <Checkbox
                          ...
                          onChange={(e) =>
                            handleCheckboxChange(e, "creditCardNo")
                          }
                          inputProps={{
                            "aria-label": "Credit Card No Checkbox",
                          }}
                          disabled
                        />
                      </Grid>
                    ...
                    <Grid item sm={6} container alignItems="center">
                      ...
                      <Grid item sm={7}>
                        <Checkbox
                          ...
                          onChange={(e) =>
                            handleCheckboxChange(e, "creditCardIssuedBy")
                          }
                          inputProps={{
                            "aria-label": "Credit Card Issued By Checkbox",
                          }}
                          disabled
                        />
                      </Grid>
                  ...
                  <Grid container spacing={2} alignItems="center">
                    ...
                    <Grid item sm={6} container alignItems="center">
                      ...
                      <Grid item sm={7}>
                        <Checkbox
                          checked={
                            checkIsFieldChecked("webURL", element.reviewId) ||
                            false
                          }
                  ...
                  <Box sx={{ margin: "20px 0" }}>
                    <Typography variant="h6">12. Passport Details#:</Typography>
                      ...
                      <Grid item sm={6} container alignItems="center">
                        ...
                        <Grid item sm={7} container alignItems="center">
                          <Checkbox
                            ...
                            onChange={(e) =>
                              handleCheckboxChange(e, "passportNo")
                            }
                            inputProps={{
                              "aria-label": "Passport No Checkbox",
                            }}
                            disabled
                          />
                        </Grid>
                      ...
                      <Grid item sm={6} container alignItems="center">
                        ...
                        <Grid item sm={7} container alignItems="center">
                          <Checkbox
                            ...
                            inputProps={{
                              "aria-label":
                                "Passport Issuing Authority Checkbox",
                            }}
                            disabled
                          />
                        </Grid>
                    ...
                    <Grid container spacing={2} sx={{ ml: 1 }}>
                      ...
                      <Grid item sm={6} container alignItems="center">
                        <Grid item sm={5}>
                          ...
                          >
                            {formatDate(
                              basicDetailsFormValues3.indivAdditionalDetails
                                .passportExpiryDate
                            )}
                          </Typography>
                        </Grid>
                        <Grid item sm={7} container alignItems="center">
                          <Checkbox
                            ...
                            onChange={(e) =>
                              handleCheckboxChange(e, "passportExpiryDate")
                            }
                            inputProps={{
                              "aria-label": "Passport Expiry Date Checkbox",
                            }}
                            disabled
                          />
                        </Grid>
                      ...
                      <Grid item sm={6}>
                        <Box sx={{ display: "flex", alignItems: "center" }}>
                          {basicDetailsFormValues3.applicationDocument
                            .filter(
                              (doc) => doc.documentTitle === "passportDocument"
                            ) // Filter for passportDocument
                            .map((doc, index) => (
                              <React.Fragment key={index}>
                                <Link
                                  ...
                                  } // Use correct doc for downloading
                                  sx={{
                                    color: "red",
                                    cursor: "pointer",
                                    textDecoration: "underline",
                                    marginRight: "8px",
                                  }} // Set text color to red and underline, add margin
                                >
                                  View
                                </Link>
                                <Grid
                  ...
                  <Typography variant="h6">14. Pan Card Details#:</Typography>

                  <Grid container spacing={2} sx={{ ml: 1 }}>
                    {/* Pan Card No */}
                    <Grid item sm={6}>
                      <Typography variant="body1">Pan Card No.:</Typography>
                    </Grid>
                    <Grid item sm={6} container alignItems="center">
                      <Grid item sm={5}>
                        <Typography
                          ...
                          .map((doc, index) => (
                            <React.Fragment key={index}>
                              <Link
                                ...
                                } // Use the correct document for downloading
                                sx={{
                                  color: "red",
                                  cursor: "pointer",
                                  textDecoration: "underline",
                                  marginRight: "8px",
                                }} // Set text color to red and underline
                              >
                                View
                              </Link>
                              <Checkbox
                                ...
                                inputProps={{
                                  "aria-label": "Pan Document Checkbox",
                                }}
                                disabled
                              />
                            </React.Fragment>
                  ...
                  <Typography variant="h6">15. ISP Details:</Typography>
                  ...
                  <Grid container spacing={2} sx={{ ml: 1 }}>
                    ...
                    <Grid item sm={6} container alignItems="center">
                      ...
                      <Grid item sm={7}>
                        <Checkbox
                          checked={
                            checkIsFieldChecked("ispName", element.reviewId) ||
                            false
                          }
                    ...
                    <Grid item sm={6} container alignItems="center">
                      ...
                      <Grid item sm={7}>
                        <Checkbox
                          ...
                          onChange={(e) =>
                            handleCheckboxChange(e, "ispWebsite")
                          }
                    ...
                    <Grid item sm={6} container alignItems="center">
                      ...
                      <Grid item sm={7}>
                        <Checkbox
                          ...
                          onChange={(e) =>
                            handleCheckboxChange(e, "ispUsername")
                          }
                  ...
                  <Grid container spacing={2} sx={{ ml: 1 }}>
                    ...
                    <Grid item sm={6} container alignItems="center">
                      ...
                      <Checkbox
                        ...
                        onChange={(e) =>
                          handleCheckboxChange(e, "personalWebPage")
                        } // Handle checkbox state change
                        inputProps={{
                          "aria-label": "Personal Web Page Checkbox",
                        }}
                        disabled
                      />
                    </Grid>
                  ...
                  <Grid container spacing={2} sx={{ ml: 1 }}>
                    ...
                    <Grid item sm={6} container alignItems="center">
                      ...
                      <Checkbox
                        ...
                        onChange={(e) =>
                          handleCheckboxChange(e, "indivCapital")
                        }
                  ...
                  <Grid container spacing={2} sx={{ ml: 1 }}>
                    ...
                    <Grid item sm={6}>
                      <Box sx={{ display: "flex", alignItems: "center" }}>
                        {basicDetailsFormValues3.applicationDocument
                          .filter(
                            (doc) => doc.documentTitle === "capitalDocument"
                          ) // Filter for capitalDocument
                          .map((doc, index) => (
                            <Box
                              key={index}
                              sx={{ display: "flex", alignItems: "center" }}
                            >
                              <Link
                                ...
                                } // Change the handler function if needed
                                sx={{
                                  color: "red",
                                  cursor: "pointer",
                                  textDecoration: "underline",
                              ...
                              <Checkbox
                                ...
                                inputProps={{
                                  "aria-label": "Capital Document Checkbox",
                                }}
                                sx={{ ml: 1 }}
                                disabled
                              />
                  ...
                  <Box sx={{ width: "100%" }}>
                      ...
                      <Grid item sm={6} container alignItems="center">
                        ...
                        <Grid item sm={7}>
                          <Checkbox
                            ...
                            onChange={(e) =>
                              handleCheckboxChange(e, "bankName")
                            }
                      ...
                      <Grid item sm={6} container alignItems="center">
                        ...
                        <Grid item sm={7}>
                          <Checkbox
                            ...
                            onChange={(e) =>
                              handleCheckboxChange(e, "branchName")
                            }
                      ...
                      <Grid item sm={6} container alignItems="center">
                        ...
                        <Grid item sm={7}>
                          <Checkbox
                            ...
                            onChange={(e) =>
                              handleCheckboxChange(e, "bankAccountNo")
                            }
                            inputProps={{
                              "aria-label": "Bank Account No Checkbox",
                            }}
                            disabled
                          />
                        </Grid>
                    ...
                    <Grid container spacing={2} sx={{ ml: 1 }}>
                      ...
                      <Grid item sm={6} container alignItems="center">
                        <Grid item sm={5}>
                          <Typography variant="body1">
                            {bankDetails?.bankAccountType || "N/A"}
                          </Typography>
                        </Grid>
                        <Grid item sm={7}>
                          <Checkbox
                            ...
                            onChange={(e) =>
                              handleCheckboxChange(e, "bankAccountType")
                            }
                            inputProps={{
                              "aria-label": "Bank Account Type Checkbox",
                            }}
                            disabled
                          />
                        </Grid>
                          ...
                          <Grid item sm={6} container alignItems="center">
                            ...
                            <Grid item sm={7}>
                              <Checkbox
                                ...
                                onChange={(e) =>
                                  handleCheckboxChange(e, "draftNumber")
                                }
                                inputProps={{
                                  "aria-label": "Draft Number Checkbox",
                                }}
                                disabled
                              />
                            </Grid>
                          ...
                          <Grid item sm={6} container alignItems="center">
                            ...
                            <Grid item sm={7}>
                              <Checkbox
                                ...
                                onChange={(e) =>
                                  handleCheckboxChange(e, "issueDate")
                                }
                                inputProps={{
                                  "aria-label": "Issue Date Checkbox",
                                }}
                                disabled
                              />
                            </Grid>
                  ...
                  <Box>
                    ...
                    >
                      31. Location of facility in India for generation of
                        ...
                        <TableBody>
                          {mappedLocations && mappedLocations.length > 0 ? (
                            mappedLocations.map((location, index) => (
                              <TableRow key={index}>
                                <TableCell
                                  sx={{ border: 0.5, borderColor: "grey.500" }}
                                >
                                ...
                                <TableCell
                                  sx={{ border: 0.5, borderColor: "grey.500" }}
                                >
                                  {location.matchingAddress.blockNo || "-"}
                                </TableCell>
                                <TableCell
                                  sx={{ border: 0.5, borderColor: "grey.500" }}
                                >
                                  {location.matchingAddress.village || "-"}
                                </TableCell>
                                <TableCell
                                  sx={{ border: 0.5, borderColor: "grey.500" }}
                                >
                                  {location.matchingAddress.postOffice || "-"}
                                </TableCell>
                                <TableCell
                                  sx={{ border: 0.5, borderColor: "grey.500" }}
                                >
                                  {location.matchingAddress.subDivision || "-"}
                                </TableCell>
                                <TableCell
                                  sx={{ border: 0.5, borderColor: "grey.500" }}
                                >
                                  {getCountryNameById(
                                    location.matchingAddress.country || "-"
                                  )}
                                </TableCell>
                                <TableCell
                                  sx={{ border: 0.5, borderColor: "grey.500" }}
                                >
                                  {getStateNameById(
                                    location.matchingAddress.state || "-"
                                  )}
                                </TableCell>
                                <TableCell
                                  sx={{ border: 0.5, borderColor: "grey.500" }}
                                >
                                  {getCityNameById(
                                    location.matchingAddress.city || "-"
                                  )}
                                </TableCell>
                                <TableCell
                                  sx={{ border: 0.5, borderColor: "grey.500" }}
                                >
                                  {location.matchingAddress.pin || "-"}
                                </TableCell>
                                <TableCell
                                  sx={{ border: 0.5, borderColor: "grey.500" }}
                                >
                  ...
                  <Box>
                    ...
                    >
                      <Grid item sm={8}>
                        <Typography variant="h6" sx={{ display: "inline" }}>
                          34. Whether Certification Practice Statement is
                          enclosed *:
                        </Typography>
                      </Grid>
                      <Grid item sm={4}>
                        <Box display="flex" alignItems="center">
                          ...
                          <Checkbox
                            ...
                            onChange={(e) =>
                              handleCheckboxChanges(
                                e,
                                "individualCPSDocument",
                                cpsDocument.appDocId
                              )
                            } // Pass appDocId here
                            inputProps={{
                              "aria-label":
                                "Certification Practice Statement Checkbox",
                            }}
                          />
                        </Box>
                      </Grid>
                    ...
                    <Grid container spacing={2}>
                      <Grid item xs={12}>
                        ...
                        <TextField
                          ...
                          fullWidth
                          onChange={(e) => handleChanges(e, "remarks")} // Pass appDocId here if needed
                          InputProps={{
                            style: {
                              padding: "10px",
                            },
