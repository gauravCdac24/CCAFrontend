      ...
      FirmApplicationForm.getAllFirmApplication3(userName)
        .then((response) => {
          ...
          const updatedLocations = filteredAppLocations.map((location) => {
            ...
            const matchingAppFirmApplication =
              location.appFirmApplication?.find(
    ...
    if (userName) {
      ...
      FirmApplicationForm.getAllFirmApplication4(userName)
        .then((response) => {
          ...
          const FirmAuthorizedRepresentative =
            response?.data?.FirmAuthorizedRepresentative;

          console.log("Filtered Locations:", filteredAppLocations);
          console.log(
            "Firm Authorized Representative:",
            FirmAuthorizedRepresentative
          );

          // Ensure both arrays contain data
          if (
            filteredAppLocations.length === 0 ||
            FirmAuthorizedRepresentative.length === 0
          ) {
          ...
          const updatedData = filteredAppLocations
            .map((location) => {
              console.log(
                "Location addressId:",
                location.addressId,
                "Type:",
                typeof location.addressId
              );
              ...
              const representative = FirmAuthorizedRepresentative
                ? {
                    ...
                    natureOfBusiness:
                      FirmAuthorizedRepresentative.natureOfBusiness,
                  }
                : null;
              ...
              if (
                location.addressId ===
                decrypt(FirmAuthorizedRepresentative?.addressId)
              ) {
                return {
                  name: `${FirmAuthorizedRepresentative.salutation} ${FirmAuthorizedRepresentative.firstName} ${FirmAuthorizedRepresentative.middleName} ${FirmAuthorizedRepresentative.lastName}`.trim(),
                  telephoneNo: FirmAuthorizedRepresentative.telephoneNo,
        ...
        showAlert({
          ...
          onConfirm: () =>
            (window.location.href =
              "/applicationreviewcommittee/newapplication"),
        });
      })
      .catch((err) => {
        const errorMessage =
  ...
  return (
    <Box p={3}>
      ...
      <Tabs
        ...
        variant="fullWidth"
      >
        <Tab label="Review Application" {...allyProps(0)} />

        <Tab label="Previous Reviewed Details" {...allyProps(1)} />
      </Tabs>
                ...
                >
                  ...
                  <Box display="flex" alignItems="center">
                    ...
                    <Typography
                      ...
                      style={{ marginRight: "8px", marginTop: "10px" }}
                    >
                      {basicDetailsFormValues?.firmApplication
                        ?.registrationNo || "N/A"}
                    </Typography>
                    <Checkbox
                      checked={
                      ...
                      disabled
                      onChange={(e) =>
                        handleCheckboxChange(e, "registrationNumber")
                      }
                      inputProps={{
                        "aria-label": "Registration Number Checkbox",
                      }}
                  ...
                  <Box display="flex" alignItems="center">
                    ...
                    <Checkbox
                      ...
                      disabled
                      onChange={(e) =>
                        handleCheckboxChange(e, "dateofPartnership")
                      }
                      inputProps={{
                        "aria-label": "Date of Partnership Checkbox",
                      }}
                      style={{ marginTop: "10px" }}
                    />
                  </Box>
                  <Box>
                      ...
                      <Grid item sm={6} container alignItems="center">
                        ...
                        <Grid item sm={7} justifyContent="flex-start">
                          <Checkbox
                            ...
                            disabled
                            onChange={(e) =>
                              handleCheckboxChange(e, "officeName")
                            }
                            inputProps={{
                              "aria-label": "Name of Office Checkbox",
                            }}
                          />
                        </Grid>
                      </Grid>
                    ...
                    <Grid container spacing={2} sx={{ ml: 1 }}>
                      ...
                      <Grid item sm={6} container alignItems="center">
                        <Grid item sm={5}>
                          <Typography variant="body1">
                            {basicDetailsFormValues.residential.blockNo ||
                              "N/A"}
                          </Typography>
                        </Grid>
                        <Grid item sm={7} justifyContent="flex-start">
                          <Checkbox
                            ...
                            inputProps={{
                              "aria-label": "Flat/Door/Block No. Checkbox",
                            }}
                          />
                        </Grid>
                      </Grid>
                    ...
                    <Grid container spacing={2} sx={{ ml: 1 }}>
                      ...
                      <Grid item sm={6} container alignItems="center">
                        <Grid item sm={5}>
                          <Typography variant="body1">
                            {basicDetailsFormValues.residential.village ||
                              "N/A"}
                          </Typography>
                        </Grid>
                        <Grid item sm={7} justifyContent="flex-start">
                          <Checkbox
                            ...
                            disabled
                            onChange={(e) =>
                              handleCheckboxChange(e, "premisesName")
                            }
                            inputProps={{
                              "aria-label": "Name of Premises Checkbox",
                            }}
                          />
                        </Grid>
                      </Grid>
                    ...
                    <Grid container spacing={2} sx={{ ml: 1 }}>
                      ...
                      <Grid item sm={6} container alignItems="center">
                        <Grid item sm={5}>
                          <Typography variant="body1">
                            {basicDetailsFormValues.residential.postOffice ||
                              "N/A"}
                          </Typography>
                        </Grid>
                        <Grid item sm={7} justifyContent="flex-start">
                          <Checkbox
                            checked={
                              checkIsFieldChecked("road", element.reviewId) ||
                              false
                            }
                            disabled
                            onChange={(e) => handleCheckboxChange(e, "road")}
                            inputProps={{
                              "aria-label": "Road/Street/Lane Checkbox",
                            }}
                          />
                        </Grid>
                      </Grid>
                    ...
                    <Grid container spacing={2} sx={{ ml: 1 }}>
                      ...
                      <Grid item sm={6} container alignItems="center">
                        <Grid item sm={5}>
                          <Typography variant="body1">
                            {basicDetailsFormValues.residential.subDivision ||
                              "N/A"}
                          </Typography>
                        </Grid>
                        <Grid item sm={7} justifyContent="flex-start">
                          <Checkbox
                            ...
                            disabled
                            onChange={(e) =>
                              handleCheckboxChange(e, "subDivision")
                            }
                            inputProps={{
                              "aria-label":
                                "Area/Locality/Taluka/Sub-Division Checkbox",
                            }}
                          />
                        </Grid>
                      </Grid>
                    ...
                    <Grid container spacing={2} sx={{ ml: 1 }}>
                      ...
                      <Grid item sm={6} container alignItems="center">
                        <Grid item sm={5}>
                          <Typography variant="body1">
                            {getCityNameById(
                              basicDetailsFormValues.residential.city || "N/A"
                            )}
                          </Typography>
                        </Grid>
                        <Grid item sm={7} justifyContent="flex-start">
                          <Checkbox
                            checked={
                              checkIsFieldChecked("city", element.reviewId) ||
                              false
                            }
                            disabled
                            onChange={(e) => handleCheckboxChange(e, "city")}
                            inputProps={{
                              "aria-label": "Town/City/District Checkbox",
                            }}
                          />
                        </Grid>
                      </Grid>
                    ...
                    <Grid container spacing={2} sx={{ ml: 1 }}>
                      ...
                      <Grid item sm={6} container alignItems="center">
                        ...
                        <Grid item sm={7} justifyContent="flex-start">
                          <Checkbox
                            checked={
                              checkIsFieldChecked("pin", element.reviewId) ||
                              false
                            }
                            disabled
                    ...
                    <Grid container spacing={2} sx={{ ml: 1 }}>
                      ...
                      <Grid item sm={6} container alignItems="center">
                        <Grid item sm={5}>
                          <Typography variant="body1">
                            {getStateNameById(
                              basicDetailsFormValues.residential.state || "N/A"
                            )}
                          </Typography>
                        </Grid>
                        <Grid item sm={7} justifyContent="flex-start">
                          <Checkbox
                            checked={
                              checkIsFieldChecked("state", element.reviewId) ||
                              false
                            }
                            disabled
                            onChange={(e) => handleCheckboxChange(e, "state")}
                            inputProps={{
                              "aria-label": "State/Union Territory Checkbox",
                            }}
                          />
                        </Grid>
                      </Grid>
                      ...
                      <Grid item sm={6} container alignItems="center">
                        ...
                        <Grid item sm={7} justifyContent="flex-start">
                          <Checkbox
                            ...
                            disabled
                            onChange={(e) =>
                              handleCheckboxChange(e, "telephoneNo")
                            }
                            inputProps={{
                              "aria-label": "Telephone No. Checkbox",
                            }}
                          />
                        </Grid>
                      </Grid>
                    ...
                    <Grid container spacing={2} sx={{ ml: 1 }}>
                      ...
                      <Grid item sm={6} container alignItems="center">
                        <Grid item sm={5}>
                          <Typography variant="body1">
                            {basicDetailsFormValues.firmApplication.fax ||
                              "N/A"}
                          </Typography>
                        </Grid>
                        <Grid item sm={7} justifyContent="flex-start">
                          <Checkbox
                            checked={
                              checkIsFieldChecked("fax", element.reviewId) ||
                              false
                            }
                            disabled
                      ...
                      <Grid item sm={6} container alignItems="center">
                        ...
                        <Grid item sm={7} justifyContent="flex-start">
                          <Checkbox
                            ...
                            disabled
                            onChange={(e) =>
                              handleCheckboxChange(e, "webPageURL")
                            }
                            inputProps={{
                              "aria-label": "Web page URL Checkbox",
                            }}
                          />
                        </Grid>
                      </Grid>
                      ...
                      <Grid item sm={6} container alignItems="center">
                        ...
                        <Grid item sm={7} justifyContent="flex-start">
                          <Checkbox
                            ...
                            disabled
                            onChange={(e) =>
                              handleCheckboxChange(e, "noOfBranches")
                            }
                            inputProps={{
                              "aria-label": "No. of Branches Checkbox",
                            }}
                          />
                        </Grid>
                      </Grid>
                      ...
                      <Grid item sm={6} container alignItems="center">
                        ...
                        <Grid item sm={7} justifyContent="flex-start">
                          <Checkbox
                            ...
                            disabled
                            onChange={(e) =>
                              handleCheckboxChange(e, "natureOfBusiness")
                            }
                            inputProps={{
                              "aria-label": "Nature of Business Checkbox",
                            }}
                          />
                        </Grid>
                      </Grid>
                    ...
                    <Grid container spacing={2}>
                      ...
                      <Grid item sm={6} container alignItems="center">
                        ...
                        <Grid item sm={4} container alignItems="center">
                          {basicDetailsFormValues2.applicationDocuments?.map(
                            (doc, index) =>
                              ...
                              doc.status === "Active" && (
                                <React.Fragment key={index}>
                                  ...
                                  <Checkbox
                                    ...
                                    inputProps={{
                                      "aria-label": "Income Tax PAN Checkbox",
                                    }}
                                    disabled
                                  />
                                </React.Fragment>
                      ...
                      <Grid item sm={4} container alignItems="center">
                        ...
                        <Grid item sm={4} justifyContent="flex-start">
                          <Checkbox
                            ...
                            disabled
                            onChange={(e) =>
                              handleCheckboxChange(e, "Turnover")
                            }
                                  ...
                                  >
                                    <Checkbox
                                      ...
                                      onChange={(e) =>
                                        handleCheckboxChanges(
                                          e,
                                          "firmNetWorthDocument",
                                          doc.appDocId
                                        )
                                      } // Pass appDocId here
                                      inputProps={{
                                        "aria-label": "Net Worth Checkbox",
                                      }}
                                      disabled
                                    />
                                  </Grid>
                        ...
                        <Grid item sm={7} container alignItems="center">
                          {basicDetailsFormValues2.applicationDocuments?.map(
                            (doc, index) => {
                              ...
                              if (
                                doc.documentTitle === "paidUpCapitalDocument" &&
                                doc.status === "Active"
                              ) {
                                return (
                                  <React.Fragment key={index}>
    ...
    /> */}
                                      ...
                                      <Checkbox
                                        ...
                                        onChange={(e) =>
                                          handleCheckboxChanges(
                                            e,
                                            "firmPaidUpCapitalDocument",
                                            doc.appDocId
                                          )
                                        } // Pass appDocId here
                                        inputProps={{
                                          "aria-label":
                                            "Paid Up Capital Checkbox",
                                        }}
                                        disabled
                                      />
                                    </Grid>
                      ...
                      <Grid item sm={6} container alignItems="center">
                        ...
                        <Grid item sm={7}>
                          <Checkbox
                            ...
                            disabled
                            onChange={(e) =>
                              handleCheckboxChange(e, "insurancePolicyNo")
                            }
                            inputProps={{
                              "aria-label": "Insurance Policy No Checkbox",
                            }}
                          />
                        </Grid>
                      </Grid>
                      ...
                      <Grid item sm={6} container alignItems="center">
                        ...
                        <Grid item sm={7}>
                          <Checkbox
                            ...
                            disabled
                            onChange={(e) =>
                              handleCheckboxChange(e, "insuranceCompany")
                            }
                            inputProps={{
                              "aria-label": "Insurer Company Checkbox",
                            }}
                          />
                        </Grid>
                      </Grid>
                        ...
                        <Grid item sm={6} container alignItems="center">
                          ...
                          <Grid item sm={7}>
                            <Checkbox
                              ...
                              inputProps={{
                                "aria-label":
                                  "authorizedReprestationName Checkbox",
                              }}
                            />
                          </Grid>
                        </Grid>
                        ...
                        <Grid item sm={6} container alignItems="center">
                          ...
                          <Grid item sm={7}>
                            <Checkbox
                              checked={
                                checkIsFieldChecked(
                                  "authorizedReprestationPostOffice",
                                  element.reviewId
                                ) || false
                              }
                              disabled
                              ...
                              inputProps={{
                                "aria-label": "Post Office Checkbox",
                              }}
                            />
                          </Grid>
                        </Grid>
                        ...
                        <Grid item sm={6} container alignItems="center">
                          ...
                          <Grid item sm={7}>
                            <Checkbox
                              checked={
                                checkIsFieldChecked(
                                  "authorizedReprestationSubDivision",
                                  element.reviewId
                                ) || false
                              }
                              disabled
                              ...
                              inputProps={{
                                "aria-label": "Sub Division Checkbox",
                              }}
                            />
                          </Grid>
                        </Grid>
                        ...
                        <Grid item sm={6} container alignItems="center">
                          ...
                          <Grid item sm={7}>
                            <Checkbox
                              checked={
                                checkIsFieldChecked(
                                  "authorizedReprestationTelephoneNo",
                                  element.reviewId
                                ) || false
                              }
                              disabled
                        ...
                        <Grid item sm={6} container alignItems="center">
                          ...
                          <Grid item sm={7}>
                            <Checkbox
                              checked={
                                checkIsFieldChecked(
                                  "authorizedReprestationNatureOfBusiness",
                                  element.reviewId
                                ) || false
                              }
                              disabled
                    ...
                    <Grid item xs={12}>
                      <Box>
                        <Typography variant="body1">
                          ...
                          suppresses any material fact from the Controller or
                          the Certifying Authority for obtaining any licence or
                          Electronic Signature Certificate, as the case may be,
                      ...
                      <Box>
                          ...
                          <Grid item sm={6} container alignItems="center">
                            ...
                            <Grid item sm={7} justifyContent="flex-start">
                              <Checkbox
                                ...
                                disabled
                                onChange={(e) =>
                                  handleCheckboxChange(e, "blockNo")
                                }
                                inputProps={{
                                  "aria-label": "Flat/Door/Block No. Checkbox",
                                }}
                        ...
                        <Grid container spacing={2} sx={{ ml: 1 }}>
                          ...
                          <Grid item sm={6} container alignItems="center">
                            <Grid item sm={5}>
                              <Typography variant="body1">
                                {basicDetailsFormValues.residential
                                  .postOffice || "N/A"}
                              </Typography>
                            </Grid>
                            <Grid item sm={7} justifyContent="flex-start">
                        ...
                        <Grid container spacing={2} sx={{ ml: 1 }}>
                          ...
                          <Grid item sm={6} container alignItems="center">
                            <Grid item sm={5}>
                              <Typography variant="body1">
                                {getCityNameById(
                                  basicDetailsFormValues.residential.city ||
                                    "N/A"
                                )}
                              </Typography>
                            </Grid>
                        ...
                        <Grid container spacing={2} sx={{ ml: 1 }}>
                          ...
                          <Grid item sm={6} container alignItems="center">
                            <Grid item sm={5}>
                              <Typography variant="body1">
                                {basicDetailsFormValues.residential.pin ||
                                  "N/A"}
                              </Typography>
                            </Grid>
                            <Grid item sm={7} justifyContent="flex-start">
                        ...
                        <Grid container spacing={2} sx={{ ml: 1 }}>
                          ...
                          <Grid item sm={6} container alignItems="center">
                            <Grid item sm={5}>
                              <Typography variant="body1">
                                {getStateNameById(
                                  basicDetailsFormValues.residential.state ||
                                    "N/A"
                                )}
                              </Typography>
                            </Grid>
                            <Grid item sm={7} justifyContent="flex-start">
                              <Checkbox
                                ...
                                inputProps={{
                                  "aria-label":
                                    "State/Union Territory Checkbox",
                                }}
                              />
                            </Grid>
                          </Grid>
    ...
    /> */}
                        ...
                        <Grid container spacing={2} sx={{ ml: 1 }}>
                          ...
                          <Grid item sm={6} container alignItems="center">
                            <Grid item sm={5}>
                              <Typography variant="body1">
                                {basicDetailsFormValues2.insurancePolicyNo ||
                                  "N/A"}
                              </Typography>
                            </Grid>
                            <Grid item sm={7}>
                        ...
                        <Grid container spacing={2} sx={{ ml: 1 }}>
                          ...
                          <Grid item sm={6} container alignItems="center">
                            <Grid item sm={5}>
                              <Typography variant="body1">
                                {basicDetailsFormValues2.insuranceCompany ||
                                  "N/A"}
                              </Typography>
                            </Grid>
                            <Grid item sm={7}>
                      ...
                      <Box sx={{ width: "100%" }}>
                        ...
                        {/* Bank Draft Section */}
                        <Typography variant="h6" style={{ marginTop: "10px" }}>
                          30. Whether bank draft/pay order for licence fee
                          enclosed: {bankDraft ? "Y" : "N"}
                        </Typography>
                        ...
                        <Grid item xs={12}>
                          <Box>
                            <Typography variant="body1">
                              ...
                              or the Certifying Authority for obtaining any
                              licence or Electronic Signature Certificate, as
                              the case may be, shall be punished with
