...
const GovernmentViewData = (props) => {
  const { id } = useParams();
    ...
    if (userName) {
      ...
      GovernmentAgencyForm.getAllGovernmentAgency(userName)
        .then((response) => {
          ...
          const { appGovtOrganizationApplication, indivAddressDTO } =
            response.data;
          ...
          setBasicDetailsFormValues({
            ...
            appGovtOrganizationApplication:
              appGovtOrganizationApplication || {}, // Set appGovtOrganizationApplication data
          });
        })
        .catch((error) => {
              ...
              <Grid item sm={6} container alignItems="center">
                <Grid item sm={5}>
                  <Typography variant="body1">
                    {basicDetailsFormValues?.appGovtOrganizationApplication
                      ?.orgName || "N/A"}
                  </Typography>
                </Grid>
                <Grid item sm={7}>
              ...
              <Grid item sm={6} container alignItems="center">
                ...
                <Grid item sm={7}>
                  <Checkbox
                    ...
                    onChange={(e) =>
                      handleCheckboxChange(e, "administrativeMinistry")
                    }
                    inputProps={{
                      "aria-label": "Administrative Ministry Checkbox",
                    }}
                  />
                </Grid>
              </Grid>
                      ...
                      mappedLocations.map((location, index) => (
                        <TableRow key={index}>
                          ...
                          >
                            <Checkbox
                              checked={
                                checkedRows[location.locationName] || false
                              }
                              onChange={(e) =>
                                handleCheckboxChange(e, location.locationName)
                              }
                              inputProps={{
                    ...
                    <Grid container spacing={2} sx={{ ml: 1 }}>
                      ...
                      <Grid item sm={6} container alignItems="center">
                        <Grid item sm={5}>
                          <Typography variant="body1">
                            {basicDetailsFormValues
                              ?.appGovtOrganizationApplication?.orgName ||
                              "N/A"}
                          </Typography>
                        </Grid>
                        <Grid item sm={7}>
                          <Checkbox
                            ...
                            onChange={(e) => handleCheckboxChange(e, "orgName")}
                            inputProps={{
                              "aria-label": "Organisation Name Checkbox",
                            }}
                          />
                        </Grid>
                      </Grid>
                    ...
                    <Grid container spacing={2} sx={{ ml: 1 }}>
                      ...
                      <Grid item sm={6} container alignItems="center">
                        ...
                        <Grid item sm={7}>
                          <Checkbox
                            checked={
                              checkedRows["administrativeMinistry"] || false
                            }
                            onChange={(e) =>
                              handleCheckboxChange(e, "administrativeMinistry")
                            }
                    ...
                    <Grid container spacing={2} sx={{ ml: 1 }}>
                      ...
                      <Grid item sm={6} container alignItems="center">
                        <Grid item sm={5}>
                          <Typography variant="body1">
                            {basicDetailsFormValues
                              ?.appGovtOrganizationApplication?.orgType ||
                              "N/A"}
                          </Typography>
                        </Grid>
                        <Grid item sm={7}>
                          <Checkbox
                            ...
                            onChange={(e) => handleCheckboxChange(e, "orgType")}
                            inputProps={{
                              "aria-label": "Government Type Checkbox",
                            }}
                          />
                        </Grid>
                      </Grid>
                    ...
                    <Grid container spacing={2} sx={{ ml: 1 }}>
                      ...
                      <Grid item sm={6} container alignItems="center">
                        <Grid item sm={5}>
                          <Typography variant="body1">
                            {basicDetailsFormValues
                              ?.appGovtOrganizationApplication?.fax || "N/A"}
                          </Typography>
                        </Grid>
                        <Grid item sm={7}>
                          <Checkbox
                    ...
                    <Grid container spacing={2} sx={{ ml: 1 }}>
                      ...
                      <Grid item sm={6} container alignItems="center">
                        <Grid item sm={5}>
                          <Typography variant="body1">
                            {basicDetailsFormValues
                              ?.appGovtOrganizationApplication?.telephoneNo ||
                              "N/A"}
                          </Typography>
                        </Grid>
                        <Grid item sm={7}>
                    ...
                    <Grid container spacing={2} sx={{ ml: 1 }}>
                      ...
                      <Grid item sm={6} container alignItems="center">
                        <Grid item sm={5}>
                          <Typography variant="body1">
                            {basicDetailsFormValues
                              ?.appGovtOrganizationApplication?.webPageURL ||
                              "N/A"}
                          </Typography>
                        </Grid>
                        <Grid item sm={7}>
                      ...
                      <Grid item sm={6} container alignItems="center">
                        <Grid item sm={5}>
                          <Typography variant="body1">
                            {`${
                              basicDetailsFormValues
                                ?.appGovtOrganizationApplication?.firstName ||
                              ""
                            } ${
                              basicDetailsFormValues
                                ?.appGovtOrganizationApplication?.middleName ||
                              ""
                            } ${
                              basicDetailsFormValues
                                ?.appGovtOrganizationApplication?.lastName || ""
                            }`.trim() || "N/A"}
                          </Typography>
                        </Grid>
                        <Grid item sm={7}>
                          <Checkbox
                            checked={checkedRows["nameOfHead"] || false}
                            onChange={(e) =>
                              handleCheckboxChange(e, "nameOfHead")
                            }
                            inputProps={{
                              "aria-label": "Name of the Head Checkbox",
                            }}
                          />
                        </Grid>
                      </Grid>
                    ...
                    <Grid container spacing={2} sx={{ ml: 1 }}>
                      ...
                      <Grid item sm={6} container alignItems="center">
                        <Grid item sm={5}>
                          <Typography variant="body1">
                            {basicDetailsFormValues
                              ?.appGovtOrganizationApplication?.designation ||
                              "N/A"}
                          </Typography>
                        </Grid>
                        <Grid item sm={7}>
                          <Checkbox
                            checked={checkedRows["designation"] || false}
                            onChange={(e) =>
                              handleCheckboxChange(e, "designation")
                            }
                            inputProps={{
                              "aria-label": "Designation Checkbox",
                            }}
                          />
                        </Grid>
                      </Grid>
                    ...
                    <Grid container spacing={2} sx={{ ml: 1 }}>
                      ...
                      <Grid item sm={6} container alignItems="center">
                        <Grid item sm={5}>
                          <Typography variant="body1">
                            {basicDetailsFormValues
                              ?.appGovtOrganizationApplication?.emailId ||
                              "N/A"}
                          </Typography>
                        </Grid>
                        <Grid item sm={7}>
                          <Checkbox
                            ...
                            onChange={(e) => handleCheckboxChange(e, "emailId")}
                            inputProps={{
                              "aria-label": "Email Address Checkbox",
                            }}
                          />
                        </Grid>
                      </Grid>
                              ...
                              mappedLocations.map((location, index) => (
                                <TableRow key={index}>
                                  ...
                                  >
                                    <Checkbox
                                      checked={
                                        checkedRows[location.locationName] ||
                                        false
                                      }
                                      onChange={(e) =>
                    ...
                    <Box style={{ marginTop: "10px" }}>
                      ...
                      <Grid container spacing={2} sx={{ ml: 1 }}>
                        ...
                        <Grid item sm={6}>
                          ...
                          >
                            {basicDetailsFormValues
                              ?.appGovtOrganizationApplication?.publicKey ||
                              "N/A"}
                          </Typography>
                        </Grid>
                      </Grid>
