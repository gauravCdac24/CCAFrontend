...
const RecommandedForeSignGoLive = () => {
    ...
    const getAllApplications = () => {
        ...
        ESPApplicationService.getEspApplicationRecommandedForEsignGoLive()
            .then((response) => {
    ...
    const viewApplication = (id) => {
        ...
        navigate(`${routeRootPath}/espapprecommended/viewrecommended/${encryptedId}`);
    };
...
export default RecommandedForeSignGoLive;
