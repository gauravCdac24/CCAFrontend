...
const ViewESPApplication = () => {
    ...
    const validateForm = () => {
      ...
      if(!rejectionForm.remarks){
        error.remarks = errorMsg.remarks.blank;
      }else if (!/^[A-Za-z0-9,./ ]+$/.test(rejectionForm.remarks)) {
        error.remarks = errorMsg.remarks.format;
    }else if(rejectionForm.remarks.length<3 || rejectionForm.remarks.length>500){
    ...
    const handleConfirmSubmit = () => {
      ...
      ESPApplicationService.approveOrRjectEspApplicationByCCA(rejectionForm)
      .then((response)=>{
...
const handleBack = () => {
  navigate(`${routeRootPath}/esprejectionapp`, { replace: true })
}
  ...
  return (
    ...
    <CustomTabPanel value={tabValue} index={0}>
      ...
      <Grid container mt={2}>
                ...
                <Table sx={{ border:  0.5, borderColor: 'grey.500' }}>
                  <TableHead>
                      <TableRow sx={{backgroundColor:"tablecolor.main", color: "tablecolor.text"}}>
                        ...
                        <TableCell sx={{ border: 0.5, borderColor: 'grey.500', fontWeight: 'bold', padding: 1, color: "inherit", width: '500px' }}>API Specification</TableCell>
        ...
        <Grid container sx={{mt : 2}}>
          <Grid item xs>
            <Typography variant="h6" fontWeight="bold" >Remarks (Only alphabets, numbers and the characters ,./ are allowed, with a minimum of 3 and maximum of 500 characters.)</Typography>
          </Grid>
        </Grid>
        ...
        <Box sx={{textAlign: 'right', mt:1}}>Characters: {rejectionForm.remarks.length}</Box>
        ...
        <Grid container direction="row" sx={{ mt: 4}} spacing={2} justifyContent="center" alignItems="center">
                                        <Grid item  >
                                            <Button type="button" fullWidth variant="contained" sx={{maxWidth: '200px' }} onClick={recommendToContinue}>
                                                Allow to Review Again
                                            </Button>
                                        </Grid>

                                        <Grid item  >
                                            <Button type="button" fullWidth variant="contained" sx={{maxWidth: '200px' }} onClick={submitForRejection}>
                                                Reject Application
                                            </Button>
                                        </Grid>
            ...
            <TableContainer>
                <Table sx={{ border:  0.5, borderColor: 'grey.500' }}>
                  <TableHead>
                      <TableRow sx={{backgroundColor:"tablecolor.main", color: "tablecolor.text"}}>
                        <TableCell sx={{ border:  0.5, borderColor: 'grey.500', fontWeight: 'bold', padding: 1, width: '60px', color: 'inherit' }}>Sl. No.</TableCell>
                        <TableCell sx={{ border: 0.5, borderColor: 'grey.500', fontWeight: 'bold', padding: 1, color: 'inherit', width: '500px' }}>eKYC Mode</TableCell>
