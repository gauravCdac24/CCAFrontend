...
const RecommandedForRejection = () => {
    ...
    const getAllApplications = () => {
        ...
        ESPApplicationService.getEspApplicationRecommandedForRejection()
            .then((response) => {
    ...
    const viewApplication = (id) => {
        ...
        navigate(`${routeRootPath}/esprejectionapp/viewdetails/${encryptedId}`);
    };
...
export default RecommandedForRejection;
