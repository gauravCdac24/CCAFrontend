...
const ViewEsignIssued = () => {
    ...
    const columns = useMemo(
        () => [
            ...
            { field: 'eSignIssued', headerName: 'eSign Issued', resizable: false, width: 150 },
    ...
    return (
        <>
         <Grid container spacing={2} direction={'column'}>
            ...
            <CustomTable customTitle = "eSign Issued List" columns={columns} rows={dsceSignIssued} hideColumnsForExport={['']} pageSizeOptions={[10, 25, 50, 100]} />
        </>
    );
};

export default ViewEsignIssued;
