...
const CCAOfficerDashboard = () =>{
  ...
  const getStateList = async() => {
    ...
    const navigateToRegisteredCA = () => {
      navigate(`${rolePath}/ccaofficerdashboard/registeredca`);
    }
    const navigateToRegisteredESP = () => {
      navigate(`${rolePath}/ccaofficerdashboard/registeredesp`);
    }
    const navigateToDSCIssued = () => {
      navigate(`${rolePath}/ccaofficerdashboard/dscissued`);
    }
    const navigateToeSignIssued = () => {
      navigate(`${rolePath}/ccaofficerdashboard/esignissued`);
    }
...
export default CCAOfficerDashboard;