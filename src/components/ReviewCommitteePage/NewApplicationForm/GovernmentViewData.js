...
import { Typography, Button, Box, Grid, InputLabel, Tooltip, Radio, FormControlLabel, TableCell, Table, TableBody, TableContainer, TableHead, TableRow, IconButton, Checkbox, TextField ,Link, TextareaAutosize, Divider, FormHelperText, Collapse, Tabs, Tab, AppBar} from '@mui/material';
...
const handleDownload = async (appDocId, documentTitle) => {
  ...
  const handleConfrimSubmit = () => {
    ...
    ApplicationReview.addAllAproved(formData)
    .then((response) => {
      //console.log(response.data)
        showAlert({
  ...
  const handleSubmit = () => {
    ...
    const formData=new FormData();
    if(2 <= (basicDetailesValues?.reviewApplications?.length || 0)){
    ...
    ApplicationReview.addGovernmentAgencyApplicationReveiw(formData)
    .then((response) => {
        showAlert({
            messageTitle: 'Success',
            messageContent: response.data,
...
<Grid container spacing={2} sx={{ ml: 1 }}>
  ...
  <Grid item sm={6} container alignItems="center">
    ...
    <Grid item sm={7}>
      <Checkbox
        checked={checkIsFieldChecked('orgName',element.reviewId) || false}
        onChange={(e) => handleCheckboxChange(e, 'orgName')}
        inputProps={{ 'aria-label': 'Organisation Name Checkbox' }}
      />
    </Grid>
...
<Grid container spacing={2} sx={{ ml: 1 }}>
  ...
  <Grid item sm={6} container alignItems="center">
    ...
    <Grid item sm={7}>
      <Checkbox
        checked={checkIsFieldChecked('administrativeMinistry',element.reviewId) || false}
        onChange={(e) => handleCheckboxChange(e, 'administrativeMinistry')}
        inputProps={{ 'aria-label': 'Administrative Ministry Checkbox' }}
      />
    </Grid>
...
<Grid container spacing={2} sx={{ ml: 1 }}>
  ...
  <Grid item sm={6} container alignItems="center">
    ...
    <Grid item sm={7}>
      <Checkbox
        checked={checkIsFieldChecked('orgType',element.reviewId) || false}
        onChange={(e) => handleCheckboxChange(e, 'orgType')}
        inputProps={{ 'aria-label': 'Government Type Checkbox' }}
      />
    </Grid>
...
<Grid container spacing={2} sx={{ ml: 1 }}>
  ...
  <Grid item sm={6} container alignItems="center">
    ...
    <Grid item sm={7}>
      <Checkbox
        checked={checkIsFieldChecked('village',element.reviewId) || false}
        onChange={(e) => handleCheckboxChange(e, 'village')}
        inputProps={{ 'aria-label': 'Village Checkbox' }}
      />
    </Grid>
...
<Grid container spacing={2} sx={{ ml: 1 }}>
  ...
  <Grid item sm={6} container alignItems="center">
    ...
    <Grid item sm={7}>
      <Checkbox
        checked={checkIsFieldChecked('nameOfHead',element.reviewId) || false}
        onChange={(e) => handleCheckboxChange(e, 'nameOfHead')}
        inputProps={{ 'aria-label': 'Name of the Head Checkbox' }}
      />
    </Grid>
...
<Grid container spacing={2} sx={{ ml: 1 }}>
  ...
  <Grid item sm={6} container alignItems="center">
    ...
    <Grid item sm={7}>
      <Checkbox
        checked={checkIsFieldChecked('designation',element.reviewId) || false}
        onChange={(e) => handleCheckboxChange(e, 'designation')}
        inputProps={{ 'aria-label': 'Designation Checkbox' }}
      />
    </Grid>
...
<Grid container spacing={2} sx={{ ml: 1 }}>
  ...
  <Grid item sm={6} container alignItems="center">
    ...
    <Grid item sm={7}>
      <Checkbox
        checked={checkIsFieldChecked('emailId',element.reviewId) || false}
        onChange={(e) => handleCheckboxChange(e, 'emailId')}
        inputProps={{ 'aria-label': 'Email Address Checkbox' }}
      />
    </Grid>
  ...
  <Grid item sm={4}>
    <Box display="flex" alignItems="center">
      ...
      {cpsDocument && (
       ...
       <Checkbox
      checked={checkIsDocChecked(cpsDocument.appDocId,element.reviewId) || false}
      onChange={(e) => handleCheckboxChanges(e, 'firmCPSDocument', cpsDocument.appDocId)} // Pass appDocId here
      inputProps={{ 'aria-label': 'Certification Practice Statement Checkbox' }}
    />
    </Box>
