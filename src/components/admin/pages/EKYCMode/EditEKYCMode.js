...
const EditEKYCMode = () => {
    ...
    useEffect(()=>{
        if(id){
            ...
            setLoading(true);
            EKYCModeService.getEKYCModeByID(decrypt(id))
            .then((response)=>{

                setFormValues({

                    ekycModeId: response.data.ekycModeId,
                    ekycModeTitle: response.data.ekycModeTitle,
                    isApprovalRequired: response.data.isApprovalRequired?"true":"false",
    ...
    const handleFormSubmit = (e) => {
        ...
        if (Object.keys(errors).length === 0) {
            ...
            if(captchaInput === captchaText){
                ...
                //Save
                EKYCModeService.updateEKYCMode(formValues)
                .then((response)=>{
    ...
    return (
        <>
            ...
            <LoaderProgress open={isLoading} />
                ...
                <FormWrapper headingText="Edit EKYC Mode">
