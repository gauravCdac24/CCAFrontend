...
const EditIntentUniqueCode = () => {
    ...
    useEffect(()=>{
        if(id){
            ...
            setLoading(true);
            IntentUniqueCodeService.getActiveUniqueCodeById(decrypt(id))
            .then((response)=>{

                setFormValues({
                    uniqueCodeId: response.data.uniqueCodeId,
    ...
    const handleFormSubmit = (e) => {
        ...
        if (Object.keys(errors).length === 0) {
            ...
            if(captchaInput === captchaText){
                setLoading(true);
                //Save
                IntentUniqueCodeService.updateIntentUniqueCode(formValues)
                .then((response)=>{

                    showAlert({
                        messageTitle: 'Unique Code',
                        messageContent: 'The details is successfully updated.' ,
                        confirmText: 'Ok',
    ...
    return (
        <>
            ...
            <LoaderProgress open={isLoading} />
                ...
                <FormWrapper headingText="Generate Unique Code">
...
export default EditIntentUniqueCode;
