...
const EditSubMenuInternalMaster = () => {
    ...
    useEffect(()=>{
        if(id){
            ...
            setLoading(true);
            SubMenuInternalMasterService.getSubMenuInternalById(decrypt(id))
            .then((response)=>{
                ...
                setSubMenuInternalFormValues({
                    ...
                    subMenuInternalId: response.data.subMenuInternalId,
                    subMenuInternalName:response.data.subMenuInternalName,
                    subMenuInternalPath: response.data.subMenuInternalPath,
                    subMenuId:response.data.subMenuId.subMenuId,
    ...
    const handleFormSubmit = (e) => {
        ...
        if (Object.keys(errors).length === 0) {
            ...
            if(captchaInput === captchaText){
                setLoading(true);
                //Save
                SubMenuInternalMasterService.updateSubMenuInternal(subMenuInternalFormValues)
                .then((response)=>{
    ...
    return (
        <>
            ...
            <LoaderProgress open={isLoading} />
                ...
                <FormWrapper headingText="Edit Sub Menu Internal">
...
export default EditSubMenuInternalMaster;
