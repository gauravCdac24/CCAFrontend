...
const EditService = () => {
    ...
    const handleFormSubmit = (e) => {
        ...
        if (Object.keys(errors).length === 0) {
            ...
            if(captchaInput === captchaText){
                ...
                //Save
                ServiceMaster.updateService(serviceFormValues)
                .then((response)=>{

                    showAlert({
                        messageTitle: 'Update Service',
    ...
    useEffect(()=>{
        if(id){
            ...
            setLoading(true);
            ServiceMaster.getServiceById(decrypt(id))
            .then((response)=>{
    ...
    return (
        ...
        <LoaderProgress open={isLoading} />
            ...
            <FormWrapper headingText="Update Service Name">
                    ...
                    <Grid container  spacing={2} direction="column">
                        ...
                        <Grid item xs={12} sm>
                            ...
                            <TextField
                                ...
                                value={serviceFormValues.serviceTitle}
                                size="small"
