...
const ViewUndertakingDetails = ({ serviceObj }) => {
    ...
    return (
        <Box>
            <Grid container spacing={2}>
                <Grid item sm={6}>
                    <Typography color="primary.tabletext" variant="h6">Undertaking Title:</Typography>
                </Grid>
                <Grid item sm={6}>
                    <Typography variant="h6">{serviceObj.undertakingsTitle}</Typography>
                </Grid>
            </Grid>
            <Grid container spacing={2}>
                <Grid item sm={6}>
                ...
                <Grid item sm={6}>
                    <Typography variant="h6">{serviceObj.appTypeMasterId.appType}</Typography>
                </Grid>
            </Grid>
...
export default ViewUndertakingDetails;
