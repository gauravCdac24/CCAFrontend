...
console.log(applicationTypeFormValues)
    ...
    const handleFormSubmit = (e) => {
        ...
        if (Object.keys(errors).length === 0) {
            ...
            if(captchaInput === captchaText){
                ...
                //Save
                ApplicationType.updateApplicationType(applicationTypeFormValues)
                .then((response)=>{

                    showAlert({
                        messageTitle: 'Update Application Type',
    ...
    useEffect(()=>{
        if(id){
            ...
            setLoading(true);
            ApplicationType.getApplicationTypeById(decrypt(id))
            .then((response)=>{

                setApplicationTypeFormValues({

                    appTypeMasterId: response.data.appTypeMasterId,
    ...
    return (
        <>
            ...
            <LoaderProgress open={isLoading} />
                ...
                <FormWrapper headingText="Update Application Type">
