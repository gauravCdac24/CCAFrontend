...
useEffect(() => {
...
}, [id, states, cities]); // Ensure that states and cities are included as dependencies
    ...
    const handlePhoneRecordChange = (index, event) => {
      ...
      const handleEmailChange = (index, event) => {
        const { name, value } = event.target;
        const updatedEmailIds = [...auditAgencyRegFormValues.emailId];
        updatedEmailIds[index] = { ...updatedEmailIds[index], [name]: value };
        setAuditAgencyRegFormValues({ ...auditAgencyRegFormValues, emailId: updatedEmailIds });
      };
      ...
      const handleAddssField = () => {
        setAuditAgencyRegFormValues(prevValues => ({
            ...prevValues,
            emailId: [...prevValues.emailId, { emailType: '', email: '' }] // Adds a new email field
        }));
    };
    ...
    const handleRemovessField = (index) => {
        setAuditAgencyRegFormValues(prevValues => ({
            ...prevValues,
            emailId: prevValues.emailId.filter((_, i) => i !== index) // Removes the email field at the given index
        }));
    };
    ...
    const handleFormSubmit = (e) => {
        ...
        // alert(captchaInput +"==="+ captchaText)
    ...
    <FormWrapper headingText="Update Audit Agency Registration Form">
                            ...
                            <Grid container  spacing={2}>
                                ...
                                {/* <Grid item xs={12} sm>
                                    <InputLabel shrink={false} htmlFor={"emailId"}>
                                        <Typography variant='body1' sx={{ color: "#000000" }}>Email Id*</Typography>
                                    </InputLabel>
                                    <TextField
                                        id="emailId"
                                        margin="dense"
                                        ...
                                        value={auditAgencyRegFormValues.emailId}
                                        size="small"
  ...
  <Grid key={index} container spacing={2}>
    ...
    <Grid item xs={12} sm={3}>
      ...
      <FormControl variant="outlined" size="small" sx={{ width: '100%', mt: 1 }}>
        <Select
          ...
          name="contactType"
          error={
            Array.isArray(formErrors.phoneRecord) &&
            formErrors.phoneRecord[index] &&
            !!formErrors.phoneRecord[index].contactType
          }
        >
    ...
    <Grid item xs={12} sm={4}>
      ...
      <TextField
        ...
        error={
          Array.isArray(formErrors.phoneRecord) &&
          formErrors.phoneRecord[index] &&
          !!formErrors.phoneRecord[index].areaCode
        }
        helperText={
          Array.isArray(formErrors.phoneRecord) &&
          formErrors.phoneRecord[index] &&
    ...
    <Grid item xs={12} sm={4}>
      ...
      <TextField
        ...
        error={
          Array.isArray(formErrors.phoneRecord) &&
          formErrors.phoneRecord[index] &&
          !!formErrors.phoneRecord[index].mobile
        }
        helperText={
          Array.isArray(formErrors.phoneRecord) &&
          formErrors.phoneRecord[index] &&
    ...
    <Grid item sm={0.4} xs={12} sx={{ display: 'flex', flexDirection: { sm: 'column', sx: 'row' } }}>
      {auditAgencyRegFormValues.phoneRecord.length > 1 && auditAgencyRegFormValues.phoneRecord.length < 3 ? (
        index === auditAgencyRegFormValues.phoneRecord.length - 1 ? (
          <>
