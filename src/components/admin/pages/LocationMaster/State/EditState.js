...
const EditState = () => {
    ...
    useEffect(()=>{
        if(id){
            ...
            console.log(id)
            setLoading(true);
            StateService.getStatebyId(decrypt(id))
            .then((response)=>{
                ...
                setStateFormValues({
                    ...
                    countryId: response.data.countryId.countryId,
    ...
    const handleFormSubmit = (e) => {
        ...
        if (Object.keys(errors).length === 0) {
            ...
            if (captchaInput === captchaText) {
                ...
                StateService.updateState(stateFormValues)
                    .then((response) => {
                        showAlert({
                            messageTitle: 'Update State',
    ...
    return (
        <>
            ...
            <FormWrapper headingText="Update State">
