...
const errorMsg = {
    documentName: {
        blank: "Please enter Document Name.",
    ...
    const handleFormSubmit = (e) => {
        ...
        if (Object.keys(errors).length === 0) {
            ...
            if(captchaInput === captchaText){
                ...
                //Save
                DocumentService.addNewDocumentName(formValues)
                .then((response)=>{

                    showAlert({
                        messageTitle: 'Add Document Master',
    ...
    return (
        <>
            ...
            <LoaderProgress open={isLoading} />
                ...
                <FormWrapper headingText="Add Document Master">
