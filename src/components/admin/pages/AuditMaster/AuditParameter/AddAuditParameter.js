    ...
    const handleFormSubmit = (e) => {
        ...
        if (Object.keys(errors).length === 0) {
            ...
            if(captchaInput === captchaText){
                ...
                //Save
                AuditParameterService.addNewAuditParameter(auditFormValues)
                .then((response)=>{

                    showAlert({
                        messageTitle: 'Add Audit Parameter',
    ...
    return (
        <>
            ...
            <LoaderProgress open={isLoading} />
                ...
                <FormWrapper headingText="Add Audit Parameter">
...
export default AddAuditParameter;
