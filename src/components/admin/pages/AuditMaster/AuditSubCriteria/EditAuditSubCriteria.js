...
const EditAuditSubCriteria = () => {
    ...
    const handleFormSubmit = (e) => {
        ...
        if (Object.keys(errors).length === 0) {
            ...
            if(captchaInput === captchaText){
                ...
                //Save
                AuditSubCriteriaService.updateAuditSubCriteria(auditFormValues)
                .then((response)=>{

                    showAlert({
                        messageTitle: 'Update Audit Sub Criteria',
    ...
    useEffect(()=>{
        if(id){
            ...
            setLoading(true);
            AuditSubCriteriaService.getAuditSubCriteriaById(decrypt(id))
            .then((response)=>{

                setAuditFormValues({

                    auditSubCriteriaId:response.data.auditSubCriteriaId,
                    auditSubCriteriaTitle:response.data.auditSubCriteriaTitle,
                    auditCriteriaId:response.data.auditCriteriaId.auditCriteriaId,
                    visible:
    ...
    return (
        <>
            ...
            <LoaderProgress open={isLoading} />
                ...
                <FormWrapper headingText="Update Audit Sub Criteria">
...
export default EditAuditSubCriteria;
