...
const EditAuditCheck = () => {
    ...
    const handleFormSubmit = (e) => {
        ...
        if (Object.keys(errors).length === 0) {
            ...
            if(captchaInput === captchaText){
                ...
                //Save
                AuditCheckService.updateAuditCheck(auditFormValues)
                .then((response)=>{

                    showAlert({
                        messageTitle: 'Update Audit Check',
    ...
    useEffect(()=>{
        if(id){
            ...
            setLoading(true);
            AuditCheckService.getAuditCheckById(decrypt(id))
            .then((response)=>{

                setAuditFormValues({

                    auditCheckId: response.data.auditCheckId,
                    auditCheckDesc: response.data.auditCheckDesc,
                ...
                setEditorText(response.data.auditCheckDesc);
            })
            .catch((err)=>{
                navigate('/admin/check', { replace: true })
            })
    ...
    return (
        <>
            ...
            <LoaderProgress open={isLoading} />
                ...
                <FormWrapper headingText="Update Audit Check">
