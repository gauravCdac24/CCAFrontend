...
const EditAuditControlType = () => {
    ...
    useEffect(()=>{
        if(id){
            ...
            setLoading(true);
            AuditControlTypeService.getAuditControlTypeById(decrypt(id))
            .then((response)=>{

                setAuditFormValues({

                    auditControlTypeId: response.data.auditControlTypeId,
                    auditControlDesc: response.data.auditControlDesc,
    ...
    const handleFormSubmit = (e) => {
        ...
        if (Object.keys(errors).length === 0) {
            ...
            if(captchaInput === captchaText){
                ...
                //Save
                AuditControlTypeService.updateAuditControlType(auditFormValues)
                .then((response)=>{

                    showAlert({
                        messageTitle: 'Update Audit Control Type',
                        messageContent: response.data,
                        confirmText: 'Ok',
                        onConfirm: () => {navigate("/admin/controltype")},
    ...
    return (
        <>
            ...
            <LoaderProgress open={isLoading} />
                ...
                <FormWrapper headingText="Update Control Type">
                        ...
                        <Grid container  spacing={2} direction="column">
                            ...
                            <Grid item xs={12} sm>
                                ...
                                <TextField
                                    ...
                                    required
                                    fullWidth
                                    placeholder='Audit Criteria Desc'
...
export default EditAuditControlType;
