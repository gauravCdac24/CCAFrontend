...
const EditAuditCriteria = () => {
    ...
    useEffect(()=>{
        if(id){
            ...
            setLoading(true);
            AuditCriteriaService.getAuditCriteriaById(decrypt(id))
            .then((response)=>{

                setAuditFormValues({

                    auditCriteriaId: response.data.auditCriteriaId,
                    auditCriteriaTitle: response.data.auditCriteriaTitle,
    ...
    const handleFormSubmit = (e) => {
        ...
        if (Object.keys(errors).length === 0) {
            ...
            if(captchaInput === captchaText){
                ...
                //Save
                AuditCriteriaService.updateAuditCriteria(auditFormValues)
                .then((response)=>{

                    showAlert({
                        messageTitle: 'Update Audit Criteria',
    ...
    return (
        <>
            ...
            <LoaderProgress open={isLoading} />
                ...
                <FormWrapper headingText="Update Audit Criteria">
...
export default EditAuditCriteria;
