...
const PreviewApplication = () => {
    ...
    const [filteredAPIVersion, setFilteredAPIVersion] = useState(null);
    ...
    const previewApplication = () => {
      ...
      ESPApplicationService.getPreview()
      .then(response=>{
        setApplicationObj(response.data);
          ...
          ESignAPIVersionMasterService.getAllAPIVersion()
            .then((data)=>{
              ...
              if(response.data.esignAPIVersion){
