            ...
            GovernmentAgencyForm.getAllGovernmentAgency(userName)
                .then((response) => {
                    ...
                    setCommunicationAddressFormValues({
                        ...
                        const filteredStates = states.filter(state => state.countryId.countryId === parseInt(communicationAddressFormValues.country));
                        setFilteredStates(filteredStates);
               
                        const filteredCities = cities.filter(city => city.stateId.stateId === parseInt(communicationAddressFormValues.state));
                        setFilteredCities(filteredCities);
